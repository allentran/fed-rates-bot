...
class PairedDocAndRates(object):
    ...
    def match_rates(self, rates_df, days = (30, 90, 180, 365)):
...
def get_json_s3(bucket, key):
    def get_object(bucket, key):
        ...
        return s3.meta.client.get_object(Bucket=bucket, Key=key)['Body'].read()
    return json.loads(get_object(bucket, key))
...
class DataTransformer(object):
    ...
    def __init__(self, data_dir, min_sentence_length):
        ...
        self.vocab = get_json_s3('litidata', 'misc/glove.vocab.json')
    ...
    def get_rates(self, api_key):
        ...
        if r.status_code == 200:
            ...
            self.rates.sort_values(by='date')
